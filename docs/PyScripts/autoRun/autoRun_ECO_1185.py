...
max_jobs = 16  # Maximum allowed concurrent jobs
component = "Ni"
sim_type = 'ECO_1185'
potential = 'FoilesNi'
Ni_ratio = 1
...
seeds =  [0, 1, 2]
job_dirs = []
job_name = f" {component}_{sim_type}TB_{ECO_DR}_{Ni_ratio}"
for j in range(0,len(seeds)):    
    for i in range(0,len(temperatures)):
        job_dirs.append(job_path + f"ECOS3_1185TB_{ECO_DR}_{temperatures[i]}/{j}/" )
